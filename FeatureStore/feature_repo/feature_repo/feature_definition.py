...
customer_fv = FeatureView(
    ...
    schema=[
        ...
        Field(name="avgmonthlylongdistancecharges", dtype=Float64),
        Field(name="customerid", dtype=String),
        Field(name="customer_tenure_months", dtype=Float64),
        Field(name="customers_all_type_services", dtype=String),
        Field(name="total_spent_bycustomer_yearly", dtype=Float64),
    ],
    online=True,
